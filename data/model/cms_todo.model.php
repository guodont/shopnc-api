...
class cms_todoModel extends Model{

    public function __construct(){
        parent::__construct('cms_todo');
    }
    ...
    public function getList($condition, $page=null, $order='', $field='*', $limit=''){
        $result = $this->table('cms_todo')->field($field)->where($condition)->page($page)->order($order)->limit($limit)->select();
        $this->cls();
        return $result;
    }
    ...
    public function getListWithClassName($condition, $page=null, $order='', $field='*', $limit=''){
        ...
        $result = $this->table('cms_todo,cms_article_class')->field($field)->join('left')->on($on)->where($condition)->page($page)->order($order)->limit($limit)->select();
        $this->cls();
        return $result;
    }
    ...
    public function getListByTagID($condition, $page=null, $order='', $field='*', $limit=''){
        ...
        $result = $this->table('cms_todo,cms_tag_relation')->field($field)->join('left')->on($on)->where($condition)->page($page)->order($order)->limit($limit)->select();
        $this->cls();
        return $result;
    }
    ...
    public function getOne($condition,$order=''){
        $result = $this->table('cms_todo')->where($condition)->order($order)->find();
        return $result;
    }
    ...
    public function isExist($condition) {
        $result = $this->table('cms_todo')->getOne($condition);
        if(empty($result)) {
            return FALSE;
        }
        else {
    ...
    public function save($param){
        return $this->table('cms_todo')->insert($param);
    }
    ...
    public function modify($update, $condition){
        return $this->table('cms_todo')->where($condition)->update($update);
    }
    ...
    public function drop($condition){
        ...
        return $this->table('cms_todo')->where($condition)->delete();
    }
