...
class member_xuekeModel{
	...
	public function add($param){
		...
		if (is_array($param)){
			...
			$result = Db::insert('member_xueke',$tmp);
			return $result;
		}else {
			return false;
		}
	...
	public function update($param){
		...
		if (is_array($param)){
			...
			$result = Db::update('member_xueke',$tmp,$where);
			return $result;
		}else {
			return false;
		}
	...
	public function del($id){
		if (intval($id) > 0){
			...
			$result = Db::delete('member_xueke',$where);
			return $result;
		}else {
			return false;
		}
	...
	public function setFleaIndexClass($param){
		...
		if (is_array($param)){
			...
			$result = Db::update('member_xueke_index',$tmp,$where);
			return $result;
		}else {
			return false;
		}
	...
	public function getFleaIndexClass($condition,$field='*'){
		$condition_str = $this->_condition($condition);
		$param = array();
		$param['table'] = 'member_xueke_index';
		$param['where'] = $condition_str;
		$result = Db::select($param);
		return $result;			
	}
