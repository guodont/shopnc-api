...
class serviceControl extends SystemControl{
    ...
    const MICROSHOP_CLASS_LIST = 'index.php?act=service&op=goodsclass_list';
    const GOODS_FLAG = 1;
...
//	}
	...
	public function service_manageOp() {
        ...
        Tpl::showpage('microshop_service.manage');
    }
    ...
    public function adv_saveOp() {
        ...
        if($result) {
            showMessage(Language::get('nc_common_save_succ'),"index.php?act=service&op=adv_manage");
        } else {
            showMessage(Language::get('nc_common_save_fail'),"index.php?act=service&op=adv_manage",'','error');
        }
    }
