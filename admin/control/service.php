		...
		*/
		...
		if (chksubmit()){
			...
			if ($error != ''){
			    ...
			    if (intval($_POST['depart_id']) != 0) {
		    	   $insert_array['depart_id']	= $_POST['depart_id'];	
		           $model_depart = Model('member_depart');
	        	   $depart_name = $model_depart->getOneGoodsClass($_POST['depart_id']);
				   $insert_array['depart_name']= $depart_name['depart_name'];
		    	}				
				...
				$insert_array['service_unit'] = trim($_POST['service_unit']);
				$insert_array['service_tag'] = trim($_POST['service_tag']);
		...
		if (chksubmit()){
			...
			if ($error != ''){
			    ...
			    if (intval($_POST['depart_id']) != 0) {
		           ...
		           $model_depart = Model('member_depart');
	        	   $depart_name = $model_depart->getOneGoodsClass($_POST['depart_id']);
				   $update_array['depart_name']= $depart_name['depart_name'];
		    	}			
				...
				$update_array['service_unit'] = trim($_POST['service_unit']);
				$update_array['service_tag'] = trim($_POST['service_tag']);
