  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=member_xueke&op=member_xueke_add" ><span>新增</span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th class="align-center">手机端显示</th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <a class="btn-add-nofloat marginleft" href="index.php?act=member_xueke&op=member_xueke_add&gc_parent_id=<?php echo $v['gc_id'];?>"><span><?php echo $lang['nc_add_sub_class'];?></span></a>
          </td>
          ...
          <td class="align-center power-onoff"><?php if($v['gc_index_show'] == 0){ ?>
            ...
            <?php } ?></td>
          <td class="w84"><a href="index.php?act=member_xueke&op=member_class_edit&gc_id=<?php echo $v['gc_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:if(confirm('<?php echo $lang['goods_class_index_ensure_del'];?>'))window.location = 'index.php?act=member_xueke&op=member_xueke_del&gc_id=<?php echo $v['gc_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
      ...
      <tfoot>
        <tr class="tfoot">
          ...
          <td id="batchAction" colspan="15"><span class="all_checkbox">
            ...
            </span>&nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" onclick="if(confirm('<?php echo $lang['goods_class_index_ensure_del'];?>')){$('#submit_type').val('del');$('form:first').submit();}"><span><?php echo $lang['nc_del'];?></span></a><a href="JavaScript:void(0);" class="btn" onclick="$('#submit_type').val('brach_edit');$('form:first').submit();"><span><?php echo $lang['nc_edit'];?></span></a></td>
        </tr>
      </tfoot>
      <?php } ?>
    </table>
...
<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/flea/jquery.member_xueke.js" charset="utf-8"></script> 
