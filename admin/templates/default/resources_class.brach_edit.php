  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['resources_class_batch_edit_batch'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form id="resources_class_form" method="post" action="index.php?act=resources_class&op=brach_edit_save" name="form1">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><ul class="nofloat">
              <li>
                ...
                <label for="gc_show-1"><?php echo $lang['resources_class_batch_edit_keep'];?></label>
              </li>
              <li>
