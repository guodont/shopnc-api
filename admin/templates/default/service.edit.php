  ...
  <form id="service_form" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td colspan="2"><textarea name="service_abstract" style="height:200px; width:690px; cols="110" rows="5" id="service_abstract" ><?php echo $output['service_array']['service_abstract'];?></textarea></td>
        </tr>			      
        <tr>
