...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>学科门类</h3>
      <ul class="tab-base">
        <li><a href="index.php?act=member_xueke&op=member_xueke"><span>管理</span></a></li>
  ...
  <form id="goods_class_form" name="goodsClassForm" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="gc_name validation">学科名称:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2" class="required"><label>手机端显示:</label></td>
        </tr>
        <tr class="noborder">
	...
	$('#goods_class_form').validate({
        ...
        rules : {
            gc_name : {
                required : true,
                remote   : {                
                url :'index.php?act=member_xueke&op=ajax&branch=check_class_name',
                type:'get',
                data:{
                    gc_name : function(){
                        return $('#gc_name').val();
