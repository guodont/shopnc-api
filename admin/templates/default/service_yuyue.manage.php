    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="goods-name w170"><?php echo $v['yuyue_service_id'];?></td>
          <td><?php echo $v['yuyue_member_id']; ?></td>		  
          <td><?php echo $v['yuyue_company_id']; ?></td>
          <td class="goods-name w270 align-center"><?php echo date('Y-m-d',$v['yuyue_start_time']);?>——<?php echo date('Y-m-d',$v['yuyue_end_time']);?></td>			  
		  <td class="align-center yes-onoff"><?php if($v['yuyue_Auditing_status'] == 0){ ?>
            <a href="JavaScript:void(0);" class=" disabled" fieldvalue="0" fieldid="<?php echo $v['yuyue_id'];?>" ajax_branch="yuyue_Auditing_status" fieldname="yuyue_Auditing_status" nc_type="inline_edit" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
            <?php }else{ ?>
            <a href="JavaScript:void(0);" class=" enabled" fieldvalue="1" fieldid="<?php echo $v['yuyue_id'];?>" ajax_branch="yuyue_Auditing_status" fieldname="yuyue_Auditing_status" nc_type="inline_edit" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
            <?php } ?></td>	
		  <td class="align-center"><?php echo $v['yuyue_pay_status']?></td>	
          <td class="align-center">
		  <?php echo $v['yuyue_Complete_status']?>
		  </td>
          <td class="w48 align-center"><a href="index.php?act=service&op=service_yuyue_edit&yuyue_id=<?php echo $v['yuyue_id']; ?>">编辑</a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
